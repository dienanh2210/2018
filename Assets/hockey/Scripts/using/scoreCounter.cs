...
namespace Com.MyCompany.MyGame
{
    public class scoreCounter : MonoBehaviour
    {
        ...
        void OnTriggerEnter2D(Collider2D collider)
        {
            ...
            {
                 collider.gameObject.GetComponent<Rigidbody2D>().transform.position= new Vector2(0, 1.9f);
...

        {
            ...
            tutoplayer.GetComponent<AiTutorial>().enabled = false;
            playerrestart.GetComponent<PlayerMove>().enabled = false;
        }
        ...
        public void issettriggerr()
        {
            ...
            playerrestart.GetComponent<PlayerMove>().enabled = true;
           tutoplayer.GetComponent<AiTutorial>().enabled = true;
